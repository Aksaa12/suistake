...
async function stakeWal() {
    try {
        ...
        // Cek apakah coinObjectsResponse ada dan merupakan objek
        ...
        if (!coinObjectsResponse.data || !Array.isArray(coinObjectsResponse.data) || coinObjectsResponse.data.length === 0) {
