...
// Log derived address for debugging
console.log("Derived Address:", derivedAddress);

// Expected address for verification (replace with actual expected address if necessary)
const expectedAddress = '0xc95a0494528da9c7052d6e831eeb2564df253b6950c27ea5f2d679990abbc75e'; // Replace with actual expected address
console.log("Expected Address:", expectedAddress);
console.log("Addresses Match:", derivedAddress === expectedAddress);

// Configuration
const config = {
    STAKENODEOPERATOR: "0xcf4b9402e7f156bc75082bc07581b0829f081ccfc8c444c71df4536ea33d094a", // Node operator address
    WAL: "0x9f992cc2430a1f442ca7a5ca7638169f5d5c00e0ebc3977a65e9ac6e497fe5ef::wal::WAL", // WAL address
    RPC: {
        NETWORK: "testnet",
        EXPLORER: "https://testnet.suivision.xyz/",
    },
    WALRUS_POOL_OBJECT_ID: "0x37c0e4d7b36a2f64d51bba262a1791f844cfd88f31379f1b7c04244061d43914", // WALRUS object ID
    STAKE_AMOUNT: 1, // Amount to stake
};
